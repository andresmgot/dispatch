...
func (o *GetFunctionURL) Build() (*url.URL, error) {
	...
	if functionName != "" {
		...
		return nil, errors.New("FunctionName is required on GetFunctionURL")
	}
...
func (o *GetFunctionURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetFunctionURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetFunctionURL")
	}
