...
func (o *UpdateFunctionURL) Build() (*url.URL, error) {
	...
	var _path = "/function/{functionName}"

	functionName := o.FunctionName
	if functionName != "" {
		_path = strings.Replace(_path, "{functionName}", functionName, -1)
	} else {
		return nil, errors.New("FunctionName is required on UpdateFunctionURL")
	}
...
func (o *UpdateFunctionURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on UpdateFunctionURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on UpdateFunctionURL")
	}
